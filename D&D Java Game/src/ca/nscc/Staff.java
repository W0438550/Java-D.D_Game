...
public class Staff extends CharacterWeapon {
    private ImageIcon staffPicture = new ImageIcon("Image/staff.jpg");
    public Staff(String weaponDescription, String name, int hpPoint, int defence, int agility, int baseAttack,  int weight, int attackModifier) {
        super(weaponDescription, name, hpPoint, defence, agility, baseAttack,  weight, attackModifier);
    }

    public ImageIcon getStaffPicture() {
        return staffPicture;
    }

    public void setStaffPicture (ImageIcon staffPicture)
    {
